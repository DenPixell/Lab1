...
class Program
{
    ...
    {
        var Person1 = new Person("Mari", "Kot", DateTime.Now);
        var Person2 = new Person("Alex", "Boston", DateTime.Now);

        var date1 = DateTime.Now;
        var date2 = new DateTime(2007, 06, 15);
        var date3 = new DateTime(2007, 10, 09);
        ...
        student.Stud = Person2;
        student.Exam = new Exam[] { new Exam("geography", 5, date3) };
        student.Group = 15;

        student.AddExams(new Exam("history", 5, date1), new Exam("PE", 5, date2));

        Console.WriteLine(student);

        Console.WriteLine(CheckArraysTimes<Student>(1000, 100, nameof(student.Group), 1000));
